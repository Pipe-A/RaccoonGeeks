...
public class PantallaAdminGestionCursoEstudiantesController {
    ...
    @FXML
    private Label nombreTablaEstudiante;
    ...
    void renderEstudiantesCurso(ActionEvent event) {
        clearWindowEstud();
        nombreTablaEstudiante.setText("Estudiantes del curso");
    ...
    void renderTodosEstudiantes(ActionEvent event) {
        clearWindowEstud();
        nombreTablaEstudiante.setText("Todos los estudiantes del sistema");
